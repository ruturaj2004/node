...
const service = require("../../services/propertyTax/privateWaterTax.service");
const requestResponsehelper = require("@baapcompany/core-api/helpers/requestResponse.helper");
const ValidationHelper = require("@baapcompany/core-api/helpers/validation.helper");

router.post(
    "/",
    checkSchema(require("../../dto/propertyTax/privateWaterTax.dto")),
    async (req, res, next) => {
...
router.get(
    "/getSubTaxType/:subTaxType",
    checkSchema({
        subTaxType: { notEmpty: true },
    }),
    async (req, res) => {
        const serviceResponse = await service.getByTaxType(req.params.subTaxType, req.query)
