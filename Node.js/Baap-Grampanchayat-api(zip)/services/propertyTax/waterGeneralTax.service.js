...
const WaterGeneralTaxModel = require("../../schema/propertyTax/waterGeneralTax.schema");
const BaseService = require("@baapcompany/core-api/services/base.service");
const taxationPeriodService = require("./taxationPeriod.service");

class WaterGeneralTaxService extends BaseService {
...
module.exports = new WaterGeneralTaxService(
    WaterGeneralTaxModel,
    "WaterGeneralTax"
);
