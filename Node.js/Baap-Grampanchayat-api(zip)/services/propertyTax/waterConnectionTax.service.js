...
const WaterConnectionTaxModel = require("../../schema/propertyTax/waterConnectionTax.schema");
const BaseService = require("@baapcompany/core-api/services/base.service");
const taxationPeriodService = require("./taxationPeriod.service");

class WaterConnectionTaxService extends BaseService {
...
module.exports = new WaterConnectionTaxService(
    WaterConnectionTaxModel,
    "WaterConnectionTax"
);
