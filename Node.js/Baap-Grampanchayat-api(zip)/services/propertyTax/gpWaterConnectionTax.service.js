...
const gpWaterConnectionTaxModel = require("../../schema/propertyTax/gpWaterConnectionTax.schema");
const BaseService = require("@baapcompany/core-api/services/base.service");
const taxationPeriodService = require("./taxationPeriod.service");

class gpWaterConnectionTaxService extends BaseService {
...
module.exports = new gpWaterConnectionTaxService(
    gpWaterConnectionTaxModel,
