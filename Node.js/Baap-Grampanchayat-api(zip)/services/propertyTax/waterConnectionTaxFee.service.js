...
const WaterConnectionTaxFeeModel = require("../../schema/propertyTax/waterConnectionTaxFee.schema");
const BaseService = require("@baapcompany/core-api/services/base.service");
const taxationPeriodService = require("./taxationPeriod.service");

class WaterConnectionTaxFeeService extends BaseService {
...
module.exports = new WaterConnectionTaxFeeService(
    WaterConnectionTaxFeeModel,
