...
router.put("/updateUserDetails/:id", async (req, res) => {
    const serviceResponse = await service.updateUserDetails(
        req.params.id,
        req.body
    );
...
router.get("/checkPhoneNumberAvailability/:phoneNumber", async (req, res) => {
    const serviceResponse = await service.checkPhoneNumberAvailability(
...
router.get("/checkEmailAvailability/:email", async (req, res) => {
    const serviceResponse = await service.checkEmailAvailability(
        req.params.email
    );
